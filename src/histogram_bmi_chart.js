...
//attach svg
  const svg1_bmi = d3.select("#BMIChart").append("svg")
...
//Scales
  ...
  let updateDiagramBMI = () => d3.csv("./data/bmi.csv").then(function (data) { //load data from cleaned csv file asynchronous
    ...
    //****************************
    //attach tooltip
    var tooltipWindow = d3.select("#BMIChart").append("div").classed("tooltipWindow", true);
...
//attach #year-slider
  const g3_bmi = d3.select("#BMIChart").append("g")
...
//attach #entity-chooser
  const g2_bmi = d3.select("#BMIChart").append("g")
